...
const handleZoom = (e, image) => {
  ...
  const cards = [
    ...
    {
      id: 15,
      name: 'Storm Superfractor 1/1 PSA 9 2025 Topps Chrome Marvel Mint Grail',
      image: '/storm-superfractor.jpeg',
      price: 'TBD',
      description: 'High-grade Storm Superfractor centerpiece card from 2025 Topps Chrome Marvel.',
