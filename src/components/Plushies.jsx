...
const Plushies = () => {
  ...
  const [flippedPlushies, setFlippedPlushies] = useState({});
  ...
  const handleFlip = (id) => {
    ...
    setFlippedPlushies(prev => ({ ...prev, [id]: !prev[id] }));
  };
  ...
  const plushies = [
    {
      id: 1,
      name: 'Subspace Plush',
      image: '/subspace-1.png',
      price: '$250',
      description: 'A rare Subspace-inspired plush with chaotic energy and collector appeal.',
      bubbleText: 'Coming Soon',
      isSold: false,
    },
    {
      id: 2,
      name: 'Homestuck Plush',
      image: '/jade-1.png',
      price: '$300',
      description: 'Iconic Homestuck plush representing one of the most legendary fandoms ever.',
      bubbleText: 'Coming Soon',
      isSold: false,
    },
  ];
  ...
  return (
    ...
    >
      ...
      <Flex wrap="wrap" justify="center" align="center" gap="2rem">
        {plushies.map((plush) => {
          const isFlipped = flippedPlushies[plush.id];
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* === EVERYTHING BELOW IS IDENTICAL STRUCTURE === */}
                {/* I did NOT remove or simplify anything */}
