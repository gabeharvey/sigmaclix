...
const Cards = () => {
  const cards = [
    ...
    { id: 2, name: '2016 Marvel Topps Chrome Web-Head 1/5 🌶️SPICY🌶️', image: '/web-head-5.jpg', price: '$25,000' },
    { id: 3, name: '2016 Marvel Topps Chrome Spider-Girl 1/5 ✨LIT✨', image: '/spider-girl-5.jpg', price: '$25,000' },
