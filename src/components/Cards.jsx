...
const Cards = () => {
  const cards = [
    ...
    { id: 2, name: '2025 Marvel Topps Chrome Web-Head 1/5 🌶️SPICY🌶️', image: '/web-head-5.jpg', price: '$2,500' },
    { id: 3, name: '2025 Marvel Topps Chrome Spider-Girl 1/5 ✨LIT✨', image: '/spider-girl-5.jpg', price: '$4,000' },
